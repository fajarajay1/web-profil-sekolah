            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        ...
                        <li>
                            <a class="smooth-menu" href="#">Prestasi</a>
                        </li>
                        <li class="dropdown">
        ...
        <div class="row">
            <div class="blog-items">
                    ...
                    <div class="single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img  src="{{ asset('/image/'.$prestasi->gambar)}}" alt="Thumb"></a>
                            </div>
                            <div class="info">
                                <h3>{{$prestasi->juara}} {{$prestasi->nama_lomba}} {{$prestasi->bidang_lomba}}</h3>
                                <p>{{ $prestasi->ket }}</p>
                                <div class="meta">
                                    <ul>
                                        <li>
                ...
                <div class="row">
                    <div class="col-md-12 pagi-area">
                        <nav aria-label="navigation">
                            <ul class="pagination"><li class="active"><a>1</a></li><li><a href="#" data-ci-pagination-page="2">2</a></li><li><a href="" data-ci-pagination-page="3">3</a></li><li><a href="#" data-ci-pagination-page="4">4</a></li><li><a href="#" data-ci-pagination-page="2" rel="next">Next</a></li></ul>                        </nav>
                    </div>
                </div>
            </div>
        </div>
